...
const config = await client.empathicVoice.configs.createConfig({
  name: `autogenerated config ${number}`,
  prompt: await client.empathicVoice.prompts.createPrompt({
    name: `autogenerated prompt ${number}`,
    text: `Start every line with ${number}.`
  })
})
...
import { Configs } from 'hume/api/resources/empathicVoice/resources/configs/client/Client'
